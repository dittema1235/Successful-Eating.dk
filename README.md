...
- Systeme.io-formularen havde ved integrationen 24. september 2026 handlingen `sendForm` på knappen “Nej tak” (`button-86abbc21`). Ret den til lukning i Systeme.io. Hjemmesidens egen “Luk”-knap fungerer uafhængigt af formularen. Indsendelse og e-maillevering er ikke afprøvet med en rigtig tilmelding.
