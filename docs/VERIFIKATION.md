...
- Visuel kontrol: desktop, mobil, behandlingsside og plan-dokument. De to nye priskort er efterfølgende kontrolleret på desktop og mobil; screenshots er opdateret. Build, site-kontrol, fire migrationstests og alle 16 browsertests består igen efter prisændringerne. Browsertesten verificerer både 4.499 kr., 645 kr. / 50 minutter, modregning til 3.854 kr., tilbagebetaling og den ærlige e-mailforespørgsel. Se screenshots.
